...
namespace ConsoleUtilitiesLibary
{
    public class Program
    {
        public static void Main (string[] args)
        {
            ...
            listener.StartListening(new CancellationToken(false));
            return;
        }
    ...
    internal class NativeMethods
    {
        ...
        [DllImportAttribute("kernel32.dll", SetLastError = true)]
        [return: MarshalAsAttribute(UnmanagedType.Bool)]
        public static extern Boolean ReadConsoleInput(ConsoleHandle hConsoleInput, ref InputRecords.INPUT_RECORD lpBuffer, UInt32 nLength, ref UInt32 lpNumberOfEventsRead);
